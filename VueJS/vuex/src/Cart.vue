    ...
    <div>
        ...
        <table v-if="cart.items.length > 0" class="table table-striped">
            ...
            <tr>
                ...
                <td>
                    <input style="width:200px;" type="text" v-model="couponCode" class="form-control" placeholder="Enter coupon code here..." >
                </td>
            </tr>
            <tr>
                <td class="text-right" colspan="2">
            ...
            <tr>
                ...
                <span v-if="couponCode">
                    <em>Lucy you! You entered the following coupon code: {{couponCode}}</em>
                </span>
...
<script>
    ...
    import { CHECKOUT,UPDATE_COUPON_CODE } from './mutations-type';
    export default {
        computed:{
            ...mapGetters([
                'cartTotal',
            ...
            // cartTotal(){
            //     return this.$store.getters.cartTotal; // Thay mapGetter
            // },
            // taxAmount(){
        ...
        methods:{
            checkout(){
                this.$store.commit('checkout'); // call mutation
            },
            ...mapMutations([
                CHECKOUT
            ]),
